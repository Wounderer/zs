...
<tr>
	...
	<tr><td colspan="2"><?= $oForm->labelEx($oActionForm, 'terms')?></td></tr>
	<tr>
		<td colspan="2">
			<?= $oForm->checkBoxList($oActionForm, 'terms', CHtml::listData($aActionTerms, 'id', 'description'))?>
			<?= $oForm->error($oActionForm, 'terms')?>
		</td>
	</tr>
